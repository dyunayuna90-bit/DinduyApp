...
export default function App() {
  ...
  const [peekingNoteId, setPeekingNoteId] = useState<string | null>(null); // NEW: State buat Note Mengembang
  ...
  // --- LOGIKA TOMBOL BACK ANDROID (ANTI-CLOSE & HIERARKI) ---
  useEffect(() => {
    const handlePopState = (event: PopStateEvent) => {
      // Urutan prioritas penutupan:
      ...
      // 3. Tutup Note Mengembang (Peeking) - INI YANG BARU
      else if (peekingNoteId) {
        setPeekingNoteId(null);
        event.preventDefault();
      }
      // 4. Tutup Folder Mengembang - INI YANG BARU
      ...
      // Kalau semua null, biarkan default (Keluar App)
    };
  ...
  // --- LOGIKA "PUSH STATE" ---
  // Setiap kali ada yang kebuka, kita "tumpuk piring" di history
  useEffect(() => {
