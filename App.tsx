...
// --- Note Editor (REWRITTEN for Viewport Logic) ---
...
const NoteEditor = ({ note, onUpdate, onClose, onDelete, onMoveNote, folders, isDark }: any) => {
  ...
  // Viewport Height Logic for Mobile Keyboard
  const [viewportHeight, setViewportHeight] = useState('100%');

  useEffect(() => {
    // Function to update height based on VisualViewport
    const handleResize = () => {
  ...
  // Uncontrolled Component Logic to prevent Cursor Jumping
  useEffect(() => {
  ...
  return (
    // Applied Dynamic Viewport Height here
    <div 
        style={{ height: viewportHeight }}
        className={`fixed top-0 left-0 w-full z-[100] flex flex-col ${isDark ? 'bg-[#121212]' : 'bg-[#fdfcf4]'}`}
    >
