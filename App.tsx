...
export default function App() {
  ...
  // -- STATES MODAL DIANGKAT KE APP UTAMA (Supaya bisa di-Back) --
  ...
  useEffect(() => {
    const handlePopState = (event: PopStateEvent) => {
      ...
      // PRIORITAS 1: MODAL & DIALOG & SETTINGS (Paling Atas)
      if (showNoteSettings) {
        setShowNoteSettings(false);
        event.preventDefault();
      }
      else if (folderSettingsId) {
      ...
      // PRIORITAS 4: PEEKING NOTE
      else if (peekingNoteId) {
        setPeekingNoteId(null);
        event.preventDefault();
      }
      // PRIORITAS 5: EXPANDED FOLDER
      else if (expandedFolderId) {
        setExpandedFolderId(null);
        event.preventDefault();
      }
      // PRIORITAS 6: SELECTION MODE
  ...
  useEffect(() => {
    ...
    // Cek semua kondisi yang "membuka" sesuatu
    if (
  ...
  // --- LOGIC MOVE SELECTED (DIPERBAIKI DISINI) ---
