...
const NoteEditor = ({ note, onUpdate, onClose, onDelete, onMoveNote, folders, isDark }: any) => {
  ...
  return (
    // FIX: Using interactive-widget meta tag strategy (native browser resizing)
    // Removed window.visualViewport JS logic entirely to stop jitter
    <div className={`fixed inset-0 z-[100] flex flex-col ${themeClass}`}>
       ...
       {/* FIX: Lists Visible with Tailwind Utility Classes */}
...
export default function App() {
  ...
  // FIX: Inject interactive-widget meta tag for stable keyboard resizing
  useEffect(() => {
