...
export const SHAPES: Shape[] = [
  'rounded-3xl', 'rounded-t-[3rem] rounded-b-2xl', 
  ...
  'rounded-t-xl rounded-b-[4rem]', 'rounded-l-xl rounded-r-[4rem]', 
  'rounded-tl-3xl rounded-br-3xl rounded-tr-md rounded-bl-md', 
  'rounded-[2rem] rounded-tr-none', 'rounded-[2.5rem] rounded-bl-none', 
  'rounded-[3rem] rounded-t-lg', 'rounded-[1.5rem] rounded-tr-[5rem]', 
  'rounded-2xl', 'rounded-none rounded-tr-3xl rounded-bl-3xl',
  'rounded-[4rem] rounded-tr-none rounded-bl-none', 'rounded-t-full rounded-b-lg',
  'rounded-b-full rounded-t-lg', 'rounded-tl-[3rem] rounded-br-[3rem] rounded-tr-none rounded-bl-none',
  'rounded-[2rem] rounded-tl-none rounded-br-none', 'rounded-l-[3rem] rounded-r-lg',
  'rounded-r-[3rem] rounded-l-lg', 'rounded-[3rem] rounded-br-lg',
